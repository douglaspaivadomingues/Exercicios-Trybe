...
// Adicione seu código aqui
const songWithid = songs.find((song) => song.id === "31031685" );

//console.log(songWithid);

//Exercício 2
//Você deve desenvolver uma função que realiza a busca de um contato telefônico em uma lista. 
//Sua tarefa é implementar a função searchContact(contacts, name), 
//que recebe uma lista de contatos e o nome do contato a ser encontrado. Se o contato for encontrado,
//retornar um objeto com todas as informações do contato utilizando spread operator. 
//Se o contato não for encontrado, retornar a mensagem “Contato não encontrado”.
...
const searchContact = (contacts, name) => {
  ...
  //Implemente a função addGender que adiciona a propriedade 
  //“gender: “Animação”” em cada objeto do array de cartoons.
